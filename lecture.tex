...
\end{definition} 
  ...
  \begin{definition}
    ...
    $\begin{matrix}\tab[1cm]
      ...
      % \end{asy}
      \includegraphics[width=5cm]{image/lecture-1.pdf}
    \end{matrix}$
  \end{definition} 
  \begin{example1}
    $n=6, \ \ \sigma=(1,3,2)$
    $\begin{matrix}\tab[1cm]
      ...
      % \end{asy}
      \includegraphics[width=4.5cm]{image/lecture-2.pdf}
    \end{matrix}$
  \end{example1}
\begin{remark}
...
\begin{proof} \tab
  \begin{itemize}
    ...
    \begin{center}
      ...
      % \end{asy}
      \includegraphics[width=7cm]{image/lecture-3.pdf}
    \end{center}
    \begin{definition}
  ...
  \begin{definition}
    ...
    \begin{center}
      ...
      % \end{asy}
      \includegraphics[width=6.5cm]{image/lecture-4.pdf}
    \end{center}
  ...
  \begin{subtheorem}
    ...
    \begin{center}
      ...
      % \end{asy}
      \includegraphics[width=6.5cm]{image/lecture-5.pdf}
    \end{center}
  ...
  \begin{center}
    ...
    % \end{asy}
    \includegraphics[width=6.5cm]{image/lecture-6.pdf}
  \end{center}
  ...
  \begin{proof}
    ...
    \begin{center}
      ...
      %   label("$Im(z)$",(0, 1.5), NW);
      % \end{asy}
      \includegraphics[width=6.5cm]{image/lecture-7.pdf}
    \end{center}
  ...
  \begin{example1}
    ...
    \begin{center}
      ...
      %   draw((0, 0) -- w[3]);
      % \end{asy}
      \includegraphics[width=6.5cm]{image/lecture-8.pdf}
    \end{center}
  \end{example1}
