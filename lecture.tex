...
\end{definition} 
  ...
  \begin{definition}
    Рангом системы векторного простанства $V$ называется $dim \langle S \rangle$, где $S\subseteq V, S \not = \varnothing$
  \end{definition} 
  $A$ - матрица $m \times n$ \\ $\\$
  ...
  \end{proof} 
  \begin{properties} \tab
    \begin{enumerate} \label{pro1}
      \item Если матрица $A$ имеет обратную, то $A^{-1}$ тоже имеет обратную, причем \\$(A^{-1})^{-1} = A$ 
      ...
      \item Если матрицы $A,B$ квадратные порядка $n$ и каждая имеет обратную, то $AB$ тоже имеет обратную, причем $(AB)^{-1} = B^{-1}A^{-1}$ 
    \end{enumerate}
  \end{properties}
  \begin{proof}
  ...
  \begin{proof}
    ...
    \begin{itemize}
      ...
      По свойству 4 \eqref{pro1}: $T_1 \cdot ... \cdot T_k$ имеет обратную \\
      ...
      По свойству 1 \eqref{pro1} : $A$, как обратная к $(T_1 \cdot ... \cdot T_k)$, имеет обратную и $A^{-1} = ((T_1 \cdot ... \cdot T_k)^{-1})^{-1} = (T_1 \cdot ... \cdot T_k)$  \\    
    \end{itemize}
  \end{proof} 
  ...
  \begin{definition}
    ...
    Обозначается: $\rho(a_1,a_2) = a_3$ 
  \end{definition}    
  Если на $A$ задана бинарная операция, то пишут $(A,*)$. Говорят, что на $A$ задана алгебраическая структура. \\
