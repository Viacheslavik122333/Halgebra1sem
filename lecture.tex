...
\end{definition} 
  ...
  \begin{example}\end{example}
    \begin{enumerate}
      \item Проекция \\
      $\phi: V^3 \to V^2, \phi: x_1i+x_2j+x_3k \to x_1i+x_2j$ РИСУНОК
      \item Поворот\\
      $\phi: V^2 \to V^2$ Поворот на угол $\alpha$ вокруг точки $O$ РИСУНОК
    \end{enumerate}
  ...
  \begin{itemize}
    ...
    \begin{proof}
      ...
      РИСУНОК 
      $$(\phi_1 + \phi_2)(e_i) = b_{1i}f_1 + \cdots + b_{mi}f_m$$ РИСУНОК 
