...
\end{definition} 
  ...
  \end{definition} 
  \begin{definition}
    Рангом матрицы $A \ m\times n$ называется ранг системы её строк. $$\includegraphics[width=4cm]{image/matr5.png}$$
  \end{definition} 
  \begin{definition}
...
\begin{proof} \tab
  ...
  \begin{proof}\tab
    \begin{itemize}
      \item[$\underline{\Longrightarrow}$] Пусть $\Z_n$ - поле, то $\forall k \in \Z_n$ имеет обратный $m : \ km=1$.\\ Предположим, что $n$ - не простое, тогда $n = st, $ где $1<s, t<n \\ \Longrightarrow s \neq 0$ в $\Z_n$
  ...
  \begin{remark}
    ...
    \begin{center}
      \begin{tikzpicture}
        ...
        \draw[fill] (O) circle (1pt) node[below left] {$0$};
      \end{tikzpicture}
    \end{center}
    \begin{center}
  ...
  \begin{definition}
    ...
    \begin{center}
      \begin{tikzpicture}[>=latex]
        ...
        % \draw[->] (0,-0.5) - - (0,3.5) node[left] {$Im(z)$};
        \draw[->] (0,0) - - node[above left] {$\rho$} (2.47,2.97) ; 
  ...
  \begin{proof}\tab
    \begin{enumerate}
      \item\begin{multline*}
        z_1 \cdot z_2 = \rho_1(\cos(\phi_1) + i\sin(\phi_1))\cdot \rho_2(\cos(\phi_2) + i\sin(\phi_2)) = \\ =(\rho_1 \cdot \rho_2)(\cos(\phi_1)\cos(\phi_2) + i\sin(\phi_1)\sin(\phi_2)) = \\ = (\rho_1 \cdot \rho_2)(\cos(\phi_1+\phi_2) + i\sin(\phi_1+\phi_2))
      \end{multline*} 
      \item Аналогично
    \end{enumerate}
  \end{proof} 
