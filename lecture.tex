...
\end{definition} 
  ...
  \end{definition} 
  \begin{definition}
    Рангом матрицы $A \ m\times n$ называется ранг системы её строк. $$\includegraphics[width=4cm]{image/lecture-3.png}$$
  \end{definition} 
  \begin{definition}
...
\begin{proof} \tab
  ...
  \begin{proof}
    % \begin{itemize}
    %   \item[ $+: \ $ ] $\frac{a_1}{b_1} + \frac{a_2}{b_2} = \frac{a_1b_2 + a_2b_1}{b_1b_1}$ 
    % \end{itemize}
    
  \end{proof} 
   \textbf{Кароче, пока что нет сил, я устал и хочу есть. В течении нескольких дней допишу...} 
  ...
  \vspace{1cm}
  \begin{center}
    \includegraphics[width=5cm]{daaa.jpg}
  \end{center}
